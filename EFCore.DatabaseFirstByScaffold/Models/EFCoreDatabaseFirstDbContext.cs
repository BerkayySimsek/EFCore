...
{
    public partial class EFCoreDatabaseFırstDbContext : DbContext
    {
        public EFCoreDatabaseFırstDbContext()
        {
        }

        public EFCoreDatabaseFırstDbContext(DbContextOptions<EFCoreDatabaseFırstDbContext> options)
            : base(options)
        {
        }
